...
@Mod(
        ...
        guiFactory = "org.cyclops.integratedterminalscompat.GuiConfigOverview$ExtendedConfigGuiFactory",
        certificateFingerprint = Reference.MOD_FINGERPRINT
)
public class IntegratedTerminalsCompat extends ModBaseVersionable {
    
    /**
     * The proxy of this mod, depending on 'side' a different proxy will be inside this field.
     * @see SidedProxy
     */
    @SidedProxy(clientSide = "org.cyclops.integratedterminalscompat.proxy.ClientProxy", serverSide = "org.cyclops.integratedterminalscompat.proxy.CommonProxy")
